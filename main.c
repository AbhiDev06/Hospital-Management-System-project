...
int main() {
    ...
    strcpy(hospitals[5].name, "Apollo Hospital");
    strcpy(hospitals[5].city, "Bengaluru");
    hospitals[5].availableBeds = 90;
    hospitals[5].pricePerBed = 2500;
    hospitals[5].rating = 4.8;
    strcpy(hospitals[5].reviews, "Top-notch medical services.");
    ...
    strcpy(patients[5].name, "Shashank");
    patients[5].age = 28;
    strcpy(patients[5].disease, "Kidney Stone");
    strcpy(patients[5].hospital, "Apollo Hospital");
